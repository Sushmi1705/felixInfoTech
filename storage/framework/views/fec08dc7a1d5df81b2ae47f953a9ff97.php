      ...
      <div class="col-lg-4">
        <div class="cta-images">
          ...
          <ul class="aniamtion-key-1">
            <li>
              <a href="#"><img src="/img/icons/check5.png" alt="" />IT Solution Services</a>
            </li>
            <li>
              <a href="#"><img src="/img/icons/check5.png" alt="" />Cyber Security Services</a>
            </li>
            <li>
              <a href="#"><img src="/img/icons/check5.png" alt="" />Software Development</a>
            </li>
          </ul>
        </div>
      </div>
...
<!-- ===== CTA AREA ENDS ======= --><?php /**PATH C:\React-Project\felixInfoTech\Eitech-Laravel_v1.0\Eitech\resources\views/layouts/partials/cta.blade.php ENDPATH**/ ?>