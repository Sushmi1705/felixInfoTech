      ...
      <div class="row">
        <div class="col-lg-8 m-auto">
          <div class="inner-header text-center heading1">
            ...
            <a href="<?php echo e(route('any', 'index')); ?>">Home <i class="fa-solid fa-angle-right"></i> <span>Portfolio</span></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-6">
          <div class="about-header-area heading2">
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
              <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="vl-btn2">Start Your Project <i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-4 text-center">
          <div class="btn-area1">
            <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="vl-btn2">Get Free Quote <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\React-Project\felixInfoTech\Eitech-Laravel_v1.0\Eitech\resources\views/pages/portfolio.blade.php ENDPATH**/ ?>