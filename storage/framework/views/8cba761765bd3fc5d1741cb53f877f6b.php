        ...
        <!-- <div class="col-lg-5"> -->
          <div class="about-header-area heading2">
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
              <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="vl-btn2">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="800">
          <div class="service1-boxarea">
            ...
            <div class="arrow">
              <a href="<?php echo e(route('second', ['services', 'single'])); ?>"><i class="fa-solid fa-arrow-right"></i></a>
            </div>
            <div class="space24"></div>
            <a href="<?php echo e(route('second', ['services', 'single'])); ?>">ICT Solutions</a>
            <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="900">
          <div class="service1-boxarea">
            ...
            <div class="space24"></div>
            <a href="<?php echo e(route('second', ['services', 'single'])); ?>">Software Solutions</a>
            <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1000">
          <div class="service1-boxarea">
            ...
            <div class="space24"></div>
            <a href="<?php echo e(route('second', ['services', 'single'])); ?>">Data Protection Services</a>
            <div class="space16"></div>
        ...
        <div class="col-lg-5">
          <div class="solution-header heading2">
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
              <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="vl-btn2">Discover Our Solutions <i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
                ...
                <div class="col-lg-4">
                  <div class="card-boxarea box1" data-aos="zoom-in" data-aos-duration="800">
                    ...
                    <div class="content-area">
                      <a href="<?php echo e(route('second', ['services', 'single'])); ?>">Discovery Consultation</a>
                  ...
                  <div class="card-boxarea box2" data-aos="zoom-in" data-aos-duration="900">
                    <div class="content-area">
                      <a href="<?php echo e(route('second', ['services', 'single'])); ?>">Customized IT Strategy</a>
                      <div class="space14"></div>
                ...
                <div class="col-lg-4">
                  <div class="card-boxarea box3" data-aos="zoom-in" data-aos-duration="800">
                    ...
                    <div class="content-area2">
                      <a href="<?php echo e(route('second', ['services', 'single'])); ?>">Quality Assurance</a>
                      <div class="space14"></div>
                  ...
                  <div class="card-boxarea box4" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="content-area2">
                      <a href="<?php echo e(route('second', ['services', 'single'])); ?>">24/7 Support</a>
                      <div class="space14"></div>
            ...
            <div class="testimonial-slider-content-area">
              ...
              <div class="testimonial-man-info-area">
                <div class="man-images-text">
                  ...
                  <div class="man-text">
                    <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Ben Stokes</a>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="800">
          <div class="team-author-boxarea">
            ...
            <div class="content-area">
              <div class="text">
                <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">SR. Alex Robertson</a>
        ...
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1000">
          <div class="team-author-boxarea">
            ...
            <div class="content-area">
              <div class="text">
                <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Shelia Abernathy</a>
                <div class="space8"></div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1200">
          <div class="team-author-boxarea">
            ...
            <div class="content-area">
              <div class="text">
                <a href="<?php echo e(route('second', ['pages', 'team'])); ?>">Devin Romaguera</a>
                <div class="space8"></div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6" data-aos="fade-left" data-aos-duration="900">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              ...
              <div class="space20"></div>
              <h4 class="vl-blog-1-title"><a href="<?php echo e(route('third', ['blog', 'details' , 'single'])); ?>">Revolutionize Your Business Operations with Advanced IT Solution Technology</a></h4>
              <div class="space16"></div>
              ...
              <div class="vl-blog-1-icon">
                <a href="<?php echo e(route('third', ['blog', 'details' , 'single'])); ?>"><i class="fa-solid fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-6" data-aos="fade-right" data-aos-duration="1000">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              ...
              <div class="space20"></div>
              <h4 class="vl-blog-1-title"><a href="<?php echo e(route('third', ['blog', 'details' , 'single'])); ?>">Transform Your Business Operations with Tailored IT Solutions Designed</a></h4>
              <div class="space16"></div>
              <p>Fuel your business success with our custom IT services. We design solutions that are tailored to your an specific needs.</p>
              <div class="vl-blog-1-icon">
                <a href="<?php echo e(route('third', ['blog', 'details' , 'single'])); ?>"><i class="fa-solid fa-arrow-right"></i></a>
        ...
        <div class="col-lg-12">
          ...
          <div class="btn-area1 text-center">
            <a href="<?php echo e(route('second', ['blog', 'blog1'])); ?>" class="vl-btn2">Read More Blog And News <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\React-Project\felixInfoTech\Eitech-Laravel_v1.0\Eitech\resources\views/index.blade.php ENDPATH**/ ?>