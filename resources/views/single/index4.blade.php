    ...
    <div class="container">
      ...
      <div class="col-lg-12">
        ...
        <div class="case-single-boxarea">
          ...
          <div class="content-area">
          <a href="{{ route('second', ['services', 'single']) }}"><span>#CloudFlex Solution</span></a>
          <div class="space16"></div>
          <a href="{{ route('second', ['services', 'single']) }}">Enhancing Productivity To with CloudFlex Solutions</a>
          <div class="arrow">
        ...
        <div class="case-single-boxarea">
          ...
          <div class="content-area">
          <a href="{{ route('second', ['services', 'single']) }}"><span>#Network Optimization</span></a>
          <div class="space16"></div>
          <a href="{{ route('second', ['services', 'single']) }}">Business Continuity with An BackupShield Data Recovery</a>
          <div class="arrow">
        ...
        <div class="case-single-boxarea">
          ...
          <div class="space16"></div>
          <a href="{{ route('second', ['services', 'single']) }}">Strengthening Security with A TechGuard Cybersecurity</a>
          <div class="arrow">
            <a href="{{ route('second', ['services', 'single']) }}"><i class="fa-solid fa-arrow-right"></i></a>
          </div>
          </div>
