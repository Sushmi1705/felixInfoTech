...
import MetisMenu from 'metismenu/dist/metisMenu.js';
...
//home 02 slider 
$('.slider-galeria-h2').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: true,
  infinite: false,
  infinite:true,
  asNavFor: '.slider-galeria-thumbs-h2',
  prevArrow: $('.testimonial-next-arrow'),
  nextArrow: $('.testimonial-prev-arrow'),
});
$('.slider-galeria-thumbs-h2').slick({
  slidesToShow: 4,
  slidesToScroll: 1,
  items:15,
  arrows: true,
  asNavFor: '.slider-galeria-h2',
  vertical: true,
  infinite:true,
  verticalSwiping: true,
  focusOnSelect: true,
